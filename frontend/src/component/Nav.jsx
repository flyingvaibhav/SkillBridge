...
{ userData && <div className='w-[50px] h-[50px] rounded-full  flex items-center justify-center text-[20px] text-white border-2 bg-black border-white cursor-pointer'  >
 ...
 <div className='w-[200px] h-[65px] border-2 border-white text-white bg-[#121213] flex items-center justify-center rounded-[10px] text-[18px] font-light cursor-pointer 'onClick={()=> navigate("/profile")}> My Profile</div>
  <div className='w-[200px] h-[65px] border-2 border-white text-white bg-[#121213] flex items-center justify-center rounded-[10px] text-[18px] font-light cursor-pointer '> My Courses</div>
 { userData?.role ==='eduactor' && <div className='w-[200px] h-[80px] border-2 border-white flex items-center justify-center text-white bg-[#121213] rounded-[10px] text-[18px] font-light cursor-pointer '> Dashboard</div>}
 { !userData ?<span className='w-[200px] h-[80px] border-2 border-white flex items-center justify-center text-white bg-[#121213] rounded-[10px] text-[18px] font-light cursor-pointer '  onClick={()=>navigate('/login')}>Login</span>:
  <span className='w-[200px] h-[65px] border-2 border-white text-white bg-[#121213] flex items-center justify-center rounded-[10px] text-[18px] font-light cursor-pointer   ' onClick={handleLogOut}> LogOut</span>}
</div>
